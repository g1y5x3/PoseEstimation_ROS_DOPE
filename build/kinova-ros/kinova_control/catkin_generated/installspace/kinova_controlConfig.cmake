...
if("FALSE" STREQUAL "TRUE")
  set(kinova_control_SOURCE_PREFIX /home/iris/yg5d6/Workspace/PoseEstimation/src/kinova-ros/kinova_control)
  set(kinova_control_DEVEL_PREFIX /home/iris/yg5d6/Workspace/PoseEstimation/devel)
  ...
  set(kinova_control_INSTALL_PREFIX /home/iris/yg5d6/Workspace/PoseEstimation/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kinova_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/iris/yg5d6/Workspace/PoseEstimation/install/${idir}'.  ${_report}")
    endif()
